...
def conv_block(inputs, outputs, kernels, paddings, pooling):
    layers = [conv_layer(inputs[i], outputs[i], kernels[i], paddings[i])
...
class VGG16(nn.Module):
    def __init__(self, n_classes=1000):
        ...
        self.conv_layer1 = conv_block(
            [3, 64], [64, 64], [3, 3], [1, 1], [2, 2])
        self.conv_layer2 = conv_block(
            [64, 128], [128, 128], [3, 3], [1, 1], [2, 2])
        self.conv_layer3 = conv_block([128, 256, 256], [256, 256, 256], [
                                      3, 3, 3], [1, 1, 1], [2, 2])
        self.conv_layer4 = conv_block([256, 512, 512], [512, 512, 512], [
                                      3, 3, 3], [1, 1, 1], [2, 2])
